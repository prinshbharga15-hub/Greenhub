...
const api = axios.create({
  baseURL: import.meta.env.VITE_API_BASE_URL !== undefined ? import.meta.env.VITE_API_BASE_URL : 'http://localhost:8000',
});
...
// Interceptor to handle unauthorized or session expiry errors
